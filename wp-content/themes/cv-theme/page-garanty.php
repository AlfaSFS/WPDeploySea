...
<main>
    <div class="content-wrapper" id="privacy">
        <h1 class="privacy"><?php pll_e("SEAFARER ПОЛІТИКА ПОВЕРНЕННЯ КОШТІВ"); ?></h1>
        <p><?php pll_e("Дата набрання чинності: 30 вересня 2025"); ?></p>
        
        <div class="privicy-description">
            <p>
                <strong><?php pll_e("Загальне правило:"); ?></strong> <?php pll_e("усі платежі за Послуги є остаточними та не підлягають поверненню, за винятком випадків, прямо передбачених цією Політикою. Придбаваючи Послуги, Користувач підтверджує свою згоду з цією Політикою повернення коштів."); ?>
            </p>
        </div>

        <div class="privicy-title">
            <h5><?php pll_e("1. ПРАВО НА ПОВЕРНЕННЯ"); ?></h5>
        </div>
        <div class="privicy-description">
            <p>
                <?php pll_e("Повернення коштів можливе лише у випадку, якщо Компанія не надала Послугу у строк, визначений в Публічному договорі."); ?>
            </p>
        </div>

        <div class="privicy-title">
            <h5><?php pll_e("2. ВИНЯТКИ"); ?></h5>
        </div>
        <div class="privicy-description">
            <p><?php pll_e("Повернення коштів не здійснюється у таких випадках:"); ?></p>
            <ul class="rules-disc">
                <li><?php pll_e("якщо Послуга була надана, незалежно від задоволеності Користувача її змістом чи якістю;"); ?></li>
                <li><?php pll_e("якщо затримка або ненадання Послуги сталися з причин, що знаходяться поза межами розумного контролю Компанії (форс-мажор);"); ?></li>
                <li><?php pll_e("якщо Користувач не надав необхідну інформацію, доступ чи сприяння, які потрібні для надання Послуги;"); ?></li>
                <li><?php pll_e("якщо Користувач порушив Публічний договір або інші застосовні політики."); ?></li>
            </ul>
        </div>

        <div class="privicy-title">
            <h5><?php pll_e("3. ПОРЯДОК ПОВЕРНЕННЯ"); ?></h5>
        </div>
        <div class="privicy-description">
            <p>
                <?php pll_e("Для запиту на повернення коштів Користувач зобов'язаний звернутися до служби підтримки Компанії у письмовій формі протягом 7 календарних днів з дати, коли Послуга мала бути надана. Запит має містити підтвердження оплати та чітке пояснення причини повернення. У разі схвалення повернення коштів воно буде здійснене протягом 14 календарних днів."); ?>
            </p>
        </div>

        <div class="privicy-title">
            <h5><?php pll_e("4. МЕТОД ПОВЕРНЕННЯ"); ?></h5>
        </div>
        <div class="privicy-description">
            <p>
                <?php pll_e("У разі схвалення повернення коштів вони перераховуються тим самим способом оплати, який використовувався під час придбання, якщо інше не погоджено з Користувачем. Компанія не несе відповідальності за затримки, спричинені банками, платіжними системами чи сторонніми провайдерами."); ?>
            </p>
        </div>

        <div class="privicy-title">
            <h5><?php pll_e("5. ЗАСТОСОВНЕ ПРАВО"); ?></h5>
        </div>
        <div class="privicy-description">
            <p>
                <?php pll_e("Ця Політика повернення коштів регулюється та тлумачиться відповідно до законодавства, визначеного в Публічному договорі Компанії."); ?>
            </p>
        </div>

        <div class="privicy-title">
            <h5><?php pll_e("6. МОВА"); ?></h5>
        </div>
        <div class="privicy-description">
            <p>
                <?php pll_e("У разі розбіжностей між різними версіями цієї Політики переважну силу має версія українською мовою."); ?>
            </p>
        </div>

        <div class="privicy-title">
            <h5><?php pll_e("7. КОНТАКТИ"); ?></h5>
        </div>
        <div class="privicy-description">
            <p>
                <?php pll_e("З будь-яких питань, претензій або повідомлень, пов'язаних із цією Політикою або Послугами, Користувач може звертатися до Компанії за адресою:"); ?> <a href="mailto:seafarercvsender@gmail.com">seafarercvsender@gmail.com</a>.
            </p>
        </div>
    </div>
